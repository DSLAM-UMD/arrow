...
mod tests {
    ...
    #[test]
    fn test_primitive_array_divide_modulus() {
    ...
    #[test]
    fn test_primitive_array_divide_modulus_sliced() {
    ...
    #[test]
    fn test_primitive_array_divide_modulus_with_nulls() {
    ...
    #[test]
    fn test_primitive_array_divide_modulus_scalar_with_nulls() {
        let a = Int32Array::from(vec![Some(15), None, Some(8), Some(1), Some(9), None]);
        let b = 3;
        let c = divide_scalar(&a, b).unwrap();
        let expected =
    ...
    #[test]
    fn test_primitive_array_divide_modulus_with_nulls_sliced() {
